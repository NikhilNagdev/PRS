...
function legendClickCallback(a) {
    for (var s = (a = a || window.event).target || a.srcElement; "LI" !== s.nodeName;) s = s.parentElement;
    var e = s.parentElement, n = parseInt(e.classList[0].split("-")[0], 10), i = Chart.instances[n],
        o = Array.prototype.slice.call(e.children).indexOf(s);
    i.legend.options.onClick.call(i, a, i.legend.legendItems[o]), i.isDatasetVisible(o) ? s.classList.remove("hidden") : s.classList.add("hidden")
}
...
function readURL(a) {
    if (a.files && a.files[0]) {
        ...
        s.onload = function (s) {
            $(a).parent(".input-file-image").find(".img-upload-preview").attr("src", s.target.result)
...
$(".nav-search .input-group > input").focus(function (a) {
    ...
    var t = !1, l = !1, r = !1, c = !1, d = 0, g = 0, h = 0, m = 0;
    if (!t) {
        var p = $(".sidenav-toggler");
        p.on("click", function () {
            1 == d ? ($("html").removeClass("nav_open"), p.removeClass("toggled"), d = 0) : ($("html").addClass("nav_open"), p.addClass("toggled"), d = 1)
        }), t = !0
    }
    if (!l) {
        var u = $(".topbar-toggler");
        u.on("click", function () {
            1 == g ? ($("html").removeClass("topbar_open"), u.removeClass("toggled"), g = 0) : ($("html").addClass("topbar_open"), u.addClass("toggled"), g = 1)
        }), l = !0
    }
    if (!r) {
        var f = $(".btn-minimize");
        $("html").hasClass("sidebar_minimize") && (h = 1, f.addClass("toggled"), f.html('<i class="fa fa-ellipsis-v"></i>')), f.on("click", function () {
            1 == h ? ($("html").removeClass("sidebar_minimize"), f.removeClass("toggled"), f.html('<i class="fa fa-bars"></i>'), h = 0) : ($("html").addClass("sidebar_minimize"), f.addClass("toggled"), f.html('<i class="fa fa-ellipsis-v"></i>'), h = 1), $(window).resize()
        }), r = !0
    }
    if (!c) {
        var b = $(".page-sidebar-toggler");
        b.on("click", function () {
            1 == m ? ($("html").removeClass("pagesidebar_open"), b.removeClass("toggled"), m = 0) : ($("html").addClass("pagesidebar_open"), b.addClass("toggled"), m = 1)
        });
        $(".page-sidebar .back").on("click", function () {
            $("html").removeClass("pagesidebar_open"), b.removeClass("toggled"), m = 0
        }), c = !0
    }
